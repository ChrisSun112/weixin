                ...
                case Event.subscribe://订阅
                    {
                        ...
                        strongResponseMessage.Articles.Add(new Article() { Title = "**,您有一个0元设计未领", PicUrl = "http://material-ui.net/content/zixun.jpg", Url = "http://material-ui.net/booking.html", Description = "您有一个0元设计未领" });
                        responseMessage = strongResponseMessage;
                        break;
                    }
