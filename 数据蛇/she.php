  ...
  <button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only"
    ...
    <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse-4">
      <ul class="am-nav am-nav-pills am-topbar-nav">
        ...
        <li class="am-active"><a href="#">多关键字短链</a></li>
...
<div class="am-form" style="width:50%;margin-top:1rem;margin-left:25%;padding-bottom:6rem;">
  
<fieldset>
  
  <div class="am-form-group">
      <label for="doc-ipt-email-1">宝贝链接<span style="color:red">*</span></label>
      <input type="text" class="" id="doc-taobei" name="link" placeholder="请输入宝贝链接">
    </div>

  <div class="am-form-group">
      <label for="doc-ipt-email-1">关键字<span style="color:red">*</span></label>
	  <div id="keyword_div">
      <input type="text" class="" name="keywords" placeholder="请输入搜索关键字">
	  </div>
	  <a style='float:right;margin-top:1rem;' id="btn_add" class="am-btn am-btn-default">
		<i class="am-icon-plus"></i>
	  </a>
    </div>

	<div class="am-form-group" style="margin-top:4rem;">
...
-->
    ...
    <p><input type="submit" name="submit" id="submit_btn" class="am-btn am-btn-default" style='width:40%;;margin-left:30%' value="提交"></input></p>
  </fieldset>
...
$("#btn_add").click(function(){
	$("#keyword_div").append('<input type="text" style="margin-top:1rem;" class="" name="keywords" placeholder="请输入搜索关键字">')
})

$("#submit_btn").click(function(){
	var keyword_list = $("input[name=keywords]");
	...
	for(var i=0;i<keyword_list.length;i++){
		...
		if($(keyword_list[i]).val()==""){
			alert("关键字不能为空");
			return;
		}
		keywords+=$(keyword_list[i]).val();
	}

	var url = $("#doc-taobei").val();
	if(url==""){
		alert("宝贝链接不能为空");
		return;
	}
	...
	$.post("multi.php",{link:url,keywords:keywords,img_url:img_url},function(result){
		...
		if(result.indexOf("数据失败")>0){
	           alert(result);
				...
				$("#result").html(result);
				$("#doc-taobei").val("");
				$("#keyword_div").html('<input type="text" style="margin-top:1rem;" class="" name="keywords" placeholder="请输入搜索关键字">');
				$("#doc-ipt-email-1").val("");
			}
	})
