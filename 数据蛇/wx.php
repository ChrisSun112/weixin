...
<article>
  <!--<header>
    <h1 style=" font-size:3rem;"></h1><p></p>
  </header><div class="ct">-->
...
<?php
    ...
    $sql = "select goods_id,keyword,imag_url from datashe where id=".$id;
   ...
   if($row = mysql_fetch_array($result))
    {
		echo "<header><h1 style='font-size:2rem;'>".$row['keyword']."</h1></header><div class='ct'>";
		
		echo "<a href='url.php?id=".$id."' target='_blank'><img src='".$row['imag_url']."' alt='' style='width: 80%;margin-left: 10%;'></a>";
